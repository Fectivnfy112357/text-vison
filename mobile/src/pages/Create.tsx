...
const TypeSelector = ({
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      >
        <div
          className={`absolute inset-0 bg-gradient-to-br from-primary-500/10 to-secondary-500/10 transition-opacity duration-300 ${
            type === "image"
              ? "opacity-100"
      ...
      >
        <div
          className={`absolute inset-0 bg-gradient-to-br from-secondary-500/10 to-primary-500/10 transition-opacity duration-300 ${
            type === "video"
              ? "opacity-100"
              : "opacity-0 group-hover:opacity-50"
          }`}
        ...
        <div className="relative z-10">
          ...
          <h3
            className={`font-semibold mb-1 transition-colors duration-300 ${
              type === "video"
                ? "text-secondary-700"
                : "text-gray-600 group-hover:text-secondary-600"
            }`}
          >
            视频生成
          </h3>
          <p
            className={`text-xs transition-colors duration-300 ${
              type === "video"
                ? "text-secondary-600"
                : "text-gray-500 group-hover:text-secondary-500"
            }`}
          >
            AI创作动态视频
          </p>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          ...
                          <div className="p-4 rounded-xl border border-gray-200 bg-white/60 backdrop-blur-sm">
                            <div className="flex items-center justify-between">
                              ...
                              <button
                                onClick={() =>
                                  updateParam("hd", !generateParams.hd)
                                }
                                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                  generateParams.hd
                                    ? "bg-purple-500"
